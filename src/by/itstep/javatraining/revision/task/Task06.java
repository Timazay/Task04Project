...
public class Task06 {
    public static boolean start(int x, int y, int z, int a, int b, int c) {
        ...
        int[] pigDimensions = {x, y, z};
        int[] truckDimensions = {a, b, c};

        for (int i = 0; i < 3; i++) {
            boolean fit = true;
            for (int j = 0; j < 3; j++) {
                if (pigDimensions[j] > truckDimensions[j]) {
                    fit = false;
                    break;
                }
            }
            ...
            int temp = pigDimensions[0];
            pigDimensions[0] = pigDimensions[1];
            pigDimensions[1] = pigDimensions[2];
            pigDimensions[2] = temp;
        }
